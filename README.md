<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Text%20Simplification%20Tool&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Text Simplification Tool Pro Header Banner" />

  <h1>🚀 Text Simplification Tool Pro</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/text-simplification-tool-pro"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Text Simplification Tool Pro** is a production-grade **TypeScript** platform engineered for high reliability, clean architectural separation, and frictionless developer workflow.
...
```bash
git clone https://github.com/hsinidev/text-simplification-tool-pro.git
cd text-simplification-tool-pro
```
